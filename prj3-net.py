...
def prj4Net():
    ...
    r1.setIP( '10.0.0.1', prefixLen=24, intf='r1-eth0' )
    r2.setIP( '10.0.0.2', prefixLen=24, intf='r2-eth0' )
    r1.setIP( '10.1.0.1', prefixLen=24, intf='r1-eth1' )
    r1.setIP( '10.2.0.1', prefixLen=24, intf='r1-eth2' )
    r2.setIP( '10.3.0.1', prefixLen=24, intf='r2-eth1' )
    r2.setIP( '10.4.0.1', prefixLen=24, intf='r2-eth2' )
    r2.setIP( '10.5.0.1', prefixLen=24, intf='r2-eth3' )
    h1.setIP( '10.1.0.3', prefixLen=24 )
    h2.setIP( '10.2.0.5', prefixLen=24 )
    h3.setIP( '10.3.0.32', prefixLen=24 )
    h4.setIP( '10.4.0.201', prefixLen=24 )
    h5.setIP( '10.5.0.54', prefixLen=24 )
